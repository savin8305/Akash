...
import { FaDownload, FaUser, FaUserTie } from "react-icons/fa";
    ...
    <>
      ...
      <div className="about_left">
        ...
        <p className="about_left_text">
          Hi! I am Akash Vishwakarma From Rewa, Madhya Pradesh .I believe my
          dedication & sincerity will help the organization and me a lot in the
          process. I have the desire, confidence and the will to do well in the
          job that I take up
        </p>
        ...
        >
          <div className="hire_me_section">
            <button className="hire_me_button">
              <a
                href="https://www.linkedin.com/in/akash9770/"
                target="_blank"
                download
                style={{
                  display: "flex",
              ...
              >
                Hire Me <FaUserTie style={{ marginLeft: "5px" }} />
              </a>
            </button>
          </div>
          <div className="hire_me_section">
